...
9. ml_evaluation_dashboard - Unified ML evaluation dashboard with all metrics/Grad-CAM
10. metadata_filter_dashboard - Filter and subset XNAT metadata with visualizations
"""
...
# -------------------------------------------------------------------------
# 9. Unified ML Evaluation Dashboard
# -------------------------------------------------------------------------
...
def ml_evaluation_dashboard(
    ...
    Examples
    --------
    >>> from src.utils.xnat_voila_dashboards import ml_evaluation_dashboard
